      ...
      <main className="flex-colum justify-center w-1/2 ">
        ...
        <form action="">
          <div className="my-8 pt-4">
            <label className="text-secondaryBlack font-dmsans font-medium">
              {" "}
              EMAIL{" "}
            </label>
            <input
          ...
          <div className="flex items-center justify-center gap-8 pt-4">
            <button className="bg-primaryPurple text-secondaryWhite font-dmsans font-medium w-1/2 py-2 rounded-full">
              {" "}
              INGRESAR{" "}
            </button>
