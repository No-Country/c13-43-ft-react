...
const participantes = [
  {
    nombre: "Alejandro Apellido",
    stack: "Frontend",
    linkedin: "https://www.linkedin.com/...",
  },
  {
    nombre: "Orlemar Apellido",
    stack: "Tester",
    linkedin: "https://www.linkedin.com/...",
  },
  {
    nombre: "Laura Apellido",
    stack: "Frontend",
    linkedin: "https://www.linkedin.com/...",
  },
  {
  ...
  return (
    <div className="w-screen flex flex-col mt-10 items-center font-dmsans">
      <div className="justify-center items-center flex flex-col max-w-3xl">
        <h1 className="text-primaryPurple font-bold text-4xl items-center justify-center pb-6">
          Conoce a Nuestro Team
        </h1>
        <h5 className="text-center">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi
          voluptatum quia sint, deserunt laborum quos in recusandae possimus rem
          mollitia nemo quis facere obcaecati praesentium eum doloremque.
          Praesentium, debitis modi!
        </h5>
      </div>
