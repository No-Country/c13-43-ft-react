...
const Init = () => {
    return (
        <main className="flex justify-between py-16 pl-16 flex-col md:flex-row">
            <article className="my-10 h-auto w-full text-center md:w-1/2 md:text-left">
                <h2 className="text-5xl font-semibold text-secondaryBlack"> Votación simplificada, decisiones tomadas en conjunto </h2>
                <div className="text-secondaryBlack my-6 pr-10">
            ...
            <div className="flex justify-end w-full md:w-1/2 aspect-square bg-red-500">
                <img 
