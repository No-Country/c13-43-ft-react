  ...
  return (
    <div>
      <Image
        ...
        height={25}
      />
      <h2 className="text-center text-2xl my-4 text-primaryPurple font-bold">
        {" "}
        {title}{" "}
      </h2>
